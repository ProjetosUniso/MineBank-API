...
public interface ContaRepository extends JpaRepository<Conta, Long> {
    ...
    @Query(value = "select new br.projetosuniso.minebank.api.Model.Conta(c.id, c.numero, c.agencia, c.senha, c.cliente, c.saldo, c.poupanca) from Conta c where c.cliente.cpf = :cpf order by c.id")
