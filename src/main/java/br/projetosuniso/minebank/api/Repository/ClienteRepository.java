...
public interface ClienteRepository extends JpaRepository<Cliente, Long> {
    ...
    @Query(value = "select new br.projetosuniso.minebank.api.Model.Cliente(c.id, c.nome, c.cpf, c.rg, c.email, c.dataNascimento, c.endereco) from Cliente c where c.cpf = :cpf order by c.id")
